...
ALTER TABLE events ADD COLUMN IF NOT EXISTS travel_local_pct NUMERIC;
ALTER TABLE events ADD COLUMN IF NOT EXISTS travel_bus_pct NUMERIC;
ALTER TABLE events ADD COLUMN IF NOT EXISTS travel_train_pct NUMERIC;
ALTER TABLE events ADD COLUMN IF NOT EXISTS travel_car_long_pct NUMERIC;
ALTER TABLE events ADD COLUMN IF NOT EXISTS travel_car_local_pct NUMERIC;
ALTER TABLE events ADD COLUMN IF NOT EXISTS long_distance_km NUMERIC;
ALTER TABLE events ADD COLUMN IF NOT EXISTS sustainability_initiatives TEXT;
ALTER TABLE events ADD COLUMN IF NOT EXISTS sdgs TEXT;
ALTER TABLE events ADD COLUMN IF NOT EXISTS event_partners TEXT;
ALTER TABLE events ADD COLUMN IF NOT EXISTS swag_description TEXT;
ALTER TABLE events ADD COLUMN IF NOT EXISTS products_sold TEXT;
ALTER TABLE events ADD COLUMN IF NOT EXISTS luma_event_id TEXT;
ALTER TABLE events ADD COLUMN IF NOT EXISTS avg_long_dist_km NUMERIC;
ALTER TABLE events ADD COLUMN IF NOT EXISTS avg_local_dist_km NUMERIC;
ALTER TABLE events ADD COLUMN IF NOT EXISTS attendee_regions TEXT;
ALTER TABLE events ADD COLUMN IF NOT EXISTS luma_csv_url TEXT;
`;
